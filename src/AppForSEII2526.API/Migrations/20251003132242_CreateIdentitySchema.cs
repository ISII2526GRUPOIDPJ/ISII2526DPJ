        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfldentification = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemForExercises", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemId = table.Column<int>(type: "int", nullable: false),
                    IncidentId1 = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    ItemForExerciseId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IncidentItems_Incidents_IncidentId1",
                        column: x => x.IncidentId1,
                        principalTable: "Incidents",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_IncidentItems_ItemForExercises_ItemForExerciseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IncidentItems_IncidentId1",
                table: "IncidentItems",
                column: "IncidentId1");
